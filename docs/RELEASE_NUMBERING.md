...
* **Current Active Release:** `11.6.0`
  * **Major 11:** Multi-asset portfolio intelligence, Coping Diary, and Monthly Recaps.
  * **Minor 6:** Negative cash balance invariant validation across ledger history, snapshot reuse optimization for cash transaction edits, asynchronous background snapshot recalculation, and prominent UI error banners.
  * **Service Release 0:** Base minor release.
* **Prior Releases:**
