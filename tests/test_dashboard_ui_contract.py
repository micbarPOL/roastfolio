...
class DashboardUiContractTests(unittest.TestCase):
    ...
    def test_gauge_sarcastic_comment_uses_readable_typography(self):
        ...
        self.assertIn("const CACHE_NAME = 'roastfolio-v63';", self.service_worker_js)
    ...
    def test_todays_movers_excludes_cash(self):
        self.assertIn("const isCash = name === 'cash' || name.includes('cash') || holdingId === '__cash__' || holdingId === 'cash'", self.dashboard_js)
        self.assertIn("return !isCash;", self.dashboard_js)
